...
# Reutilizando as funções do seu código
from main import adicionar_tarefa, remover_tarefa, listar_tarefas, concluir_tarefa, listar_tarefas_pendentes, gerar_id, tarefas
